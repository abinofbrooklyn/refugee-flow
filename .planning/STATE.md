...
- [Phase 12-security-hardening]: Helmet v3 -> v8: v8 bundles TS types; @types/helmet@0.0.48 conflicts with v8
- [Phase 12-security-hardening]: Accept xlsx@0.18.5 HIGH risk: no upstream fix, admin-only route behind ADMIN_SECRET
...
- Phase 11 renamed: About Page Relaunch (expanded from Data Methodology & Attribution to full About page refresh)
- Phase 12 added: Security Hardening (credential rotation, CSP, error sanitization, npm audit, Helmet upgrade)
