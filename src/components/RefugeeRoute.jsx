...
export default class RefugeeRoute extends React.Component {
  ...
  constructor(props){
    ...
    this.state = {
        loading: true,
        error: null,
        currentRouteName: _.find(["Eastern Mediterranean","Central Mediterranean","Western Mediterranean","Western Balkans","Eastern Land Borders","Western African","Americas","Horn of Africa","East & Southern Africa","Iran-Afghanistan Corridor","South & East Asia","English Channel"],d => d.replace(/[^a-zA-Z0-9]/g, '') === props.match.params.arg),
