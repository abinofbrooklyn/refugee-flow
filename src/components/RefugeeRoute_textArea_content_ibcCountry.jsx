  ...
  render(){
    ...
    return(
      <Wrapper className='route-map-titleGroup__IBC'>
        ...
        <DataSource onClick={() => window.open(this.currentRouteName === 'Americas' ? 'https://www.cbp.gov/newsroom/stats/nationwide-encounters' : 'https://frontex.europa.eu/along-eu-borders/migratory-map/', '_blank')}>
