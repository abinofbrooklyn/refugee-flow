  ...
  render(){
    ...
    return(
      <Wrapper className='route-map-titleGroup__IBC'>
        ...
        <DataSource onClick={() => window.open(this.currentRouteName === 'Americas' ? 'https://www.cbp.gov/newsroom/stats/nationwide-encounters' : this.currentRouteName === 'English Channel' ? 'https://www.gov.uk/government/statistical-data-sets/immigration-system-statistics-data-tables' : 'https://frontex.europa.eu/along-eu-borders/migratory-map/', '_blank')}>
