...
const year: string[] = ['2010', '2011', '2012', '2013', '2014', '2015', '2016', '2017', '2018'];
...
const countryCode: CountryEntry[] = [
  ...
  { code: 'IR', full: 'IRAN' },
  { code: 'IL', full: 'ISRAEL' },
  { code: 'PS', full: 'PALESTINE' },
  { code: 'YE', full: 'YEMEN' },
  { code: 'AF', full: 'AFGHANISTAN' },
  { code: 'TR', full: 'TURKEY' },
  { code: 'IQ', full: 'IRAQ' },
  { code: 'SY', full: 'SYRIA' },
  { code: 'CF', full: 'CENTRAL AFRICAN REPUBLIC' },
  { code: 'KE', full: 'KENYA' },
  { code: 'NG', full: 'NIGERIA' },
  { code: 'RW', full: 'RWANDA' },
  ...
  { code: 'ZW', full: 'ZIMBABWE' },
  { code: 'SS', full: 'SOUTH SUDAN' },
  { code: 'TD', full: 'CHAD' },
  { code: 'BH', full: 'BAHRAIN' },
  { code: 'LK', full: 'SRI LANKA' },
  { code: 'MZ', full: 'MOZAMBIQUE' },
  { code: 'ZA', full: 'SOUTH AFRICA' },
  { code: 'SA', full: 'SAUDI ARABIA' },
  { code: 'DZ', full: 'ALGERIA' },
  { code: 'MR', full: 'MAURITANIA' },
  { code: 'TN', full: 'TUNISIA' },
  { code: 'GQ', full: 'GUINEA' },
  { code: 'LR', full: 'LIBERIA' },
  { code: 'MG', full: 'MADAGASCAR' },
  { code: 'SN', full: 'SENEGAL' },
  { code: 'TZ', full: 'TANZANIA' },
  { code: 'ZM', full: 'ZAMBIA' },
  { code: 'LB', full: 'LEBANON' },
  { code: 'MA', full: 'MOROCCO' },
  { code: 'GW', full: 'GUINEA-BISSAU' },
  { code: 'JO', full: 'JORDAN' },
  { code: 'BI', full: 'BURUNDI' },
  { code: 'CI', full: 'IVORY COAST' },
  { code: 'BF', full: 'BURKINA FASO' },
  { code: 'NE', full: 'NIGER' },
  { code: 'GQ', full: 'EQUATORIAL GUINEA' },
  { code: 'GM', full: 'GAMBIA' },
  { code: 'GA', full: 'GABON' },
  { code: 'TG', full: 'TOGO' },
  { code: 'NA', full: 'NAMIBIA' },
  { code: 'MW', full: 'MALAWI' },
  { code: 'SZ', full: 'SWAZILAND' },
  { code: 'OM', full: 'OMAN' },
  { code: 'VN', full: 'VIETNAM' },
  { code: 'KH', full: 'CAMBODIA' },
  { code: 'KW', full: 'KUWAIT' },
  { code: 'SL', full: 'SIERRA LEONE' },
  { code: 'ER', full: 'ERITREA' },
  { code: 'DJ', full: 'DJIBOUTI' },
  { code: 'LS', full: 'LESOTHO' },
  { code: 'LA', full: 'LAOS' },
  { code: 'AE', full: 'UNITED ARAB EMIRATES' },
  { code: 'QA', full: 'QATAR' },
  { code: 'BW', full: 'BOTSWANA' },
];

const eventDict: string[] = [
